import { defineJob, InMemoryJobRepository } from '@kmgeon/stepflow';
import type { JobExecution, JobParameters } from '@kmgeon/stepflow';
import { describe, expect, it } from 'vitest';

import { runJobsParallel } from '../../src/puppeteer/run-jobs-parallel';
